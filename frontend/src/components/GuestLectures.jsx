        ...
        <TitleText title={<>Guest Lectures</>} textStyles="text-center" />
            <div className="flex gap-10 mx-auto justify-center">
                <div className="my-20 flex justify-center">
                    ...
                    whileTap={{ scale: 0.9 }}  src="Dr_Satheesh_Reddy.jpg" className="w-[90%] my-4 rounded-xl mx-auto h-[200px]" />
                    ...
                    whileTap={{ scale: 0.9 }}  src="Dr A.S. Pillai.jpg" className="w-[90%] my-4 rounded-xl mx-auto h-[200px]" />
                        <p className="w-[90%] text-md text-left ml-5 my-2">
                    ...
                    whileTap={{ scale: 0.9 }}  src="Pete-Draper.jpg" className="w-[90%] my-4 rounded-xl mx-auto h-[200px]" />
                        <p className="w-[90%] text-md text-left ml-5 my-2">
